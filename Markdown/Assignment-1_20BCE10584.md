## **Assignment 1 - 20BCE10584 - IWP**

<br>

>Q. Design the form displayed, with all validation.
    ...
    <div class="wrapper">
        ...
        <form method="POST" onsubmit="return validate()">
            ...
            <div class="input-group">
                <div class="input-box">
                    <h4> Date of Birth</h4>
                    <input required type="text" placeholder="DD" class="dob" id="dd">
                    <input required type="text" placeholder="MM" class="dob" id="mm">
                    <input required type="text" placeholder="YYYY" class="dob" id="yyyy">
                </div>
            ...
            <div class="input-group">
                <div class="input-box">
                    <input type="tel" placeholder="Card Number" required class="name" id="card">
                    <i class="fa fa-credit-card icon"></i>
                </div>
                <p id="errorcard" style="color: red"></p>
            </div>
            <div class="input-group">
                <div class="input-box">
                    <input type="tel" placeholder="Card CVC" required class="name" id="cvc">
                    <i class="fa fa-user icon"></i>
                </div>
                <p id="errorcvc" style="color: red"></p>
                <div class="input-box">
                    <select>
