...
export class News extends Component {
    ...
    async componentDidMount() {
        let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=32e8e8d6244546d992e4cb9419b7c42c&page=1&pagesize=${this.props.pageSize}`
        this.setState({
            loading : true
        })
     ...
     handleNextClick = async() => {
        ...
        if(!(this.state.page+1 > Math.ceil(this.state.totalResults/this.props.pageSize))){
            ...
            let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=32e8e8d6244546d992e4cb9419b7c42c&page=${this.state.page+1}&pagesize=${this.props.pageSize}`
    ...
    render() {
        return (
            <div className="container my-3">
                <h1 className="text-center">Bit News - Top headlines</h1>
                ...
                <div className="row">
                    ...
                    <div className="d-flex justify-content-between">
                        <button disabled={this.state.page<=1} type="button" className="btn btn-info mx-3 my-5" onClick={this.handlePreviousClick}>Previous</button>
                        <button disabled={this.state.page+1 > Math.ceil(this.state.totalResults/this.props.pageSize)} type="button" className="btn btn-info my-5" onClick={this.handleNextClick}>Next</button>
                    </div>
                </div>
            </div>
        )
