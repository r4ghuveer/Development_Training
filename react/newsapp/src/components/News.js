...
export class News extends Component {
    ...
    async componentDidMount() {
        let url = "https://newsapi.org/v2/top-headlines?country=in&apiKey=32e8e8d6244546d992e4cb9419b7c42c&page=1&pagesize=20"
     ...
     handleNextClick = async() => {
        ...
        if(this.state.page+1 > Math.ceil(this.state.totalResults/20)){
            ...
            let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=32e8e8d6244546d992e4cb9419b7c42c&page=${this.state.page+1}&pagesize=20`
            let data = await fetch(url);
            console.log(data);
            let parsedData = await data.json();
            console.log(parsedData);
            ...
            <div className="container my-3">
                ...
                <div className="col-md-3">
                    ...
                    <div className="d-flex justify-content-between">
                        ...
                        <button type="button" className="btn btn-info my-5" onClick={this.handleNextClick}>Next</button>
                    </div>
                </div>
                {/* <NewsItem title="my title" description="my desc"/> */}
            </div>
